...
_Cập nhật lần cuối: 2026-09-24_

## Danh sách chủ đề

| File                        | Tóm tắt                                                              |
| --------------------------- | --------------------------------------------------------------------- |
| [[critical-constraints]]    | Các quy tắc cứng của dự án — đọc trước khi đụng vào route hay module nào |
...
_Bổ sung dần khi có thêm bài wiki._
